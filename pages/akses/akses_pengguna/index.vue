    ...
    <base-header class="pb-6">
      <div class="row align-items-center py-4">
        ...
        <div class="col-lg-6 col-5 text-right">
          ...
          <nuxt-link to="/akses/akses_pengguna/add" class="btn btn-neutral btn-sm">New</nuxt-link>
      ...
      <div>
        <card class="no-border-card" body-classes="px-0 pb-1" footer-classes="pb-2">
          <template slot="header">
            <h3 class="mb-0">Akses Pengguna</h3>
            <p class="text-sm mb-0">Management page for Akses Pengguna data</p>
          </template>
          <div>
            ...
            <el-table :data="tableData" row-key="id" header-row-class-name="thead-light">
              ...
              <el-table-column min-width="200px" align="right" label="Actions">
                <div slot-scope="{$index, row}" class="d-flex">
                  <nuxt-link :to="{name: 'akses-akses_pengguna-edit', params: {id: row.id_}}">
...
//   mixins: [clientPaginationMixin],
  ...
  methods: {
    ...
    deleteRow(row) {
      this.$axios
        .$delete(`main_c/akses_pengguna/pengguna/` + row.id_)
        .then((user) => {
          swal.fire({
            title: "Deleted!",
