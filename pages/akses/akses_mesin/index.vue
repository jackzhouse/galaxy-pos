    ...
    <base-header class="pb-6">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">Master</h6>
        ...
        <div class="col-lg-6 col-5 text-right">
          ...
          <nuxt-link to="/akses/akses_mesin/add" class="btn btn-neutral btn-sm"
            >New</nuxt-link
          >
      ...
      <div>
        ...
        >
          <template slot="header">
            <h3 class="mb-0">Mesin Akses</h3>
            <p class="text-sm mb-0">Management page for mesin akses data</p>
          </template>
          <div>
            <div
...
export default {
  ...
  data() {
    return {
      mesinAksesData: [],
      propsToSearch: ["idMesin", "namaMesin ", "keterangan"],
      tableColumns: [
        // {
        //   type: "number",
        // },
      ...
      tableInfo: {},
      selectedRows: [],
      url: "main_c​/mesin_akses​/get_mesin",
      paging: {
        size: 10,
        totalElements: 0,
        totalPages: 0,
  ...
  methods: {
    getDatas(size, page) {
      this.$axios
        .$post(
          "main_c/mesin_akses/get_mesin" + "?size=" + size + "&page=" + page,
          {
            search: [],
          }
        )
    ...
    handleEdit(index, row) {
      console.log(row);
      swal.fire({
        title: `Do you want to edit ${row.namaMesin} ?`,
        buttonsStyling: false,
    ...
    deleteRow(row) {
      this.$axios
        .$delete(`main_c/mesin_akses/mesin/` + row.id_)
        .then((user) => {
          swal.fire({
            title: "Deleted!",
            text: `${row.namaMesin} has been deleted.`,
            type: "success",
            confirmButtonClass: "btn btn-success btn-fill",
            buttonsStyling: false,
          });
        ...
        .catch((error) => {
          swal.fire({
            title: "Delete Failed!",
            text: `Failed deleting ${row.namaMesin}`,
            type: "failed",
