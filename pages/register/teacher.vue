        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              <h1 class="text-white">Creating a Teacher Account</h1>
              <p class="text-lead text-white">Create new account for your teacher.</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="card bg-secondary border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <!-- <validation-observer v-slot="{handleSubmit}" ref="formValidator">
                ...
                <form class="needs-validation" @submit.prevent="registerTeacherSubmit">
  ...
  data() {
    return {
      form: {
        ...
        crmPipeline: "PENDAFTARAN PENGAJAR",
        solution: "CRM",
        // hardcode companycode, solution & crmPipeline
        companyRegister: "",
        teacherRegister: "",
        address: "",
        phone: "",
