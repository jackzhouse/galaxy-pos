    ...
    <base-header class="pb-6">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">Data Form</h6>
      ...
      <div>
        ...
        >
          <template slot="header">
            <h3 class="mb-0">Website - Data Form</h3>
            <p class="text-sm mb-0">Management page for Website - Data Form</p>
          </template>
          <div>
            <div
            ...
            >
              ...
              <el-table-column min-width="200px" align="right" label="Actions">
                <div slot-scope="{ $index, row }" class="d-flex">
                  <nuxt-link
                    :to="{
                      name: 'website-website_form-edit',
                      params: { id: row.id },
                    }"
                  >
...
export default {
  ...
  methods: {
    ...
    deleteRow(row) {
      this.$axios
        .$delete(`main_b/page/form/` + row.id)
        .then((user) => {
          swal.fire({
            title: "Deleted!",
