    ...
    <base-header class="pb-6">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0"> Gambar Slider</h6>
        ...
        <div class="col-lg-6 col-5 text-right">
          ...
          <nuxt-link to="/website/website_slider/add" class="btn btn-neutral btn-sm">Tambah Slider Gambar</nuxt-link>
      ...
      <div>
        ...
        >
          <template slot="header">
            <h3 class="mb-0">Website - Gambar Slider</h3>
            <p class="text-sm mb-0">Management page for Website - Gambar Slider </p>
          </template>
          <div>
            ...
            <el-table :data="tableData" row-key="id" header-row-class-name="thead-light">
              ...
              <el-table-column min-width="200px" align="right" label="Actions">
                <div slot-scope="{ $index, row }" class="d-flex">
                  <nuxt-link
                    :to="{
                      name: 'website-website_slider-edit',
                      params: { id: row.id_ },
                    }"
                  >
...
export default {
  ...
  data() {
    return {
      ...
      tableInfo: {},
      selectedRows: [],
      url: `main_b/slider/get_slider/${this.$store.state.user.company.companyId}`,
      paging: {
        size: 10,
        totalElements: 0,
        totalPages: 0,
  ...
  methods: {
    ...
    deleteRow(row) {
      this.$axios
        .$delete(`main_b/slider/slider/` + row.id_)
        .then((user) => {
          swal.fire({
            title: "Deleted!",
