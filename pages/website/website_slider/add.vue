      ...
      <div class="row">
        <div class="col">
          <div class="card-wrapper">
            <card>
              <!-- Card header -->
              <h3 slot="header" class="mb-0">Buat Slider Gambar</h3>
              <!-- <validation-observer v-slot="{handleSubmit}" ref="formValidator"> -->
              <validation-observer ref="form">
                <form class="needs-validation" @submit.prevent="sliderSubmit">
                  <div class="col-md-12">
                  ...
                  <nuxt-link class="btn btn-warning" to="/website/website_slider">Cancel</nuxt-link>
                </form>
              </validation-observer>
            </card>
          </div>
      ...
      if (this.doSubmit) {
        await this.$refs.form.validate().then((success) => {
          if (!success) {
            ...
            if (result == true) {
              this.$axios
                .$post(`main_b/slider/slider`, this.form)
                .then((response) => {
                  swal.fire({
                    title: `Sukses`,
