    ...
    <base-header class="pb-6">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">Data Video</h6>
      ...
      <div>
        ...
        >
          <template slot="header">
            <h3 class="mb-0">Website - Data Video</h3>
            <p class="text-sm mb-0">Management page for Website - Data Video</p>
          </template>
          <div>
            <div
              class="col-12 d-flex justify-content-center justify-content-sm-between flex-wrap mb-2 mt--3"
            >
              <el-select
            ...
            >
              ...
              <el-table-column min-width="200px" align="right" label="Actions">
                <div slot-scope="{ $index, row }" class="d-flex">
                  <nuxt-link
                    :to="{
                      name: 'website-website_video-edit',
                      params: { id: row.id },
                    }"
                  >
...
export default {
  ...
  methods: {
    ...
    deleteRow(row) {
      this.$axios
        .$delete(`main_b/page/video/` + row.id)
        .then((user) => {
          swal.fire({
            title: "Deleted!",
