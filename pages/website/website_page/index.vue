      ...
      <div>
        ...
        >
          <template slot="header">
            <h3 class="mb-0">Website - Data Page</h3>
            <p class="text-sm mb-0">Management page for Website - Data Page</p>
          </template>
          <div>
            <div
            ...
            >
              ...
              <el-table-column min-width="200px" align="right" label="Actions">
                <div slot-scope="{ $index, row }" class="d-flex">
                  <nuxt-link
                    :to="{
                      name: 'website-website_page-edit',
                      params: { id: row.id },
                    }"
                  >
...
export default {
  ...
  methods: {
    getDatas(size, page) {
      this.$axios
        .$post("main_b/page/all" + "?size=" + size + "&page=" + page, {
          search: [],
        })
    ...
    deleteRow(row) {
      this.$axios
        .$delete(`main_b/page/page/` + row.id)
        .then((user) => {
          swal.fire({
            title: "Deleted!",
