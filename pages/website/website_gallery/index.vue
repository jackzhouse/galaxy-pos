    ...
    <base-header class="pb-6">
      <div class="row align-items-center py-4">
        ...
        <div class="col-lg-6 col-5 text-right">
          ...
          <nuxt-link
            to="/website/website_gallery/add"
      ...
      <div>
        ...
        >
          <template slot="header">
            <h3 class="mb-0">Website - Data Gallery</h3>
            <p class="text-sm mb-0">
              Management page for Website - Data Gallery
            </p>
          </template>
          <div>
            <div
            ...
            >
              ...
              <el-table-column min-width="200px" align="right" label="Actions">
                <div slot-scope="{ $index, row }" class="d-flex">
                  <nuxt-link
                    :to="{
                      name: 'website-website_gallery-edit',
                      params: { id: row.id },
                    }"
                  >
...
export default {
  ...
  methods: {
    ...
    deleteRow(row) {
      this.$axios
        .$delete(`main_b/page/image/` + row.id)
        .then((user) => {
          swal.fire({
            title: "Deleted!",
