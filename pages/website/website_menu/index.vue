      ...
      <div>
        ...
        >
          <template slot="header">
            <h3 class="mb-0">Website - Data Menu</h3>
            <p class="text-sm mb-0">Management page for Website - Data Menu</p>
          </template>
          <div>
            <div
            ...
            >
              ...
              <el-table-column min-width="200px" align="right" label="Actions">
                <div slot-scope="{ $index, row }" class="d-flex">
                  <nuxt-link
                    :to="{
                      name: 'website-website_menu-edit',
                      params: { id: row.id },
                    }"
                  >
...
export default {
  ...
  methods: {
    getDatas(size, page) {
      this.$axios
        .$post("main_b/menu/all" + "?size=" + size + "&page=" + page, {
          search: [],
        })
