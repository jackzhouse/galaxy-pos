    ...
    <base-header class="pb-6">
      <div class="row align-items-center py-4">
        ...
        <div class="col-lg-6 col-5 text-right">
          ...
          <nuxt-link to="/absen/absen_shift/add" class="btn btn-neutral btn-sm"
      ...
      <div>
        ...
        >
          <template slot="header">
            <h3 class="mb-0">Data Shift</h3>
            <p class="text-sm mb-0">Management page for Shift data</p>
          </template>
          <div>
            <div
...
export default {
  ...
  methods: {
    ...
    handleEdit(index, row) {
      console.log(row);
      swal.fire({
        title: `You want to edit ${row.namaShift}`,
        buttonsStyling: false,
    ...
    deleteRow(row) {
      this.$axios
        .$delete(`main_c/shift/shift/` + row.id_)
        .then((user) => {
          swal.fire({
            title: "Deleted!",
            text: `You deleted ${row.namaShift}`,
            type: "success",
            confirmButtonClass: "btn btn-success btn-fill",
            buttonsStyling: false,
          });
        ...
        .catch((error) => {
          swal.fire({
            title: "Delete Failed!",
            text: `Failed to delete ${row.namaShift}`,
            type: "failed",
