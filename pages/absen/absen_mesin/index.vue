    ...
    <base-header class="pb-6">
      <div class="row align-items-center py-4">
        ...
        <div class="col-lg-6 col-5 text-right">
          ...
          <nuxt-link to="/absen/absen_mesin/add" class="btn btn-neutral btn-sm"
      ...
      <div>
        ...
        >
          <template slot="header">
            <h3 class="mb-0">Mesin Absen</h3>
            <p class="text-sm mb-0">Management page for mesin absen data</p>
          </template>
          <div>
            <div
...
export default {
  ...
  methods: {
    ...
    deleteRow(row) {
      this.$axios
        .$delete(`main_c/mesin/mesin/` + row.id_)
        .then((user) => {
          swal.fire({
            title: "Deleted!",
