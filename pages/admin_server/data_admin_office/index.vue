    ...
    <base-header class="pb-6">
      <div class="row align-items-center py-4">
        ...
        <div class="col-lg-6 col-5 text-right">
          <nuxt-link to="data_admin_office/form" class="btn btn-neutral btn-sm"
          ...
          <el-table
            ...
            <el-table-column min-width="180px" align="right" label="Actions">
              <div slot-scope="{ $index, row }" class="d-flex">
                <!-- <nuxt-link
                  :to="{
                    name: 'admin_server-data_admin_office-edit',
                    params: { id: row.id_ },
                  }"
                > -->
                <nuxt-link
                  :to="`/admin_server/data_admin_office/form?id=`+row.id_"                  
                >
...
export default {
  ...
  data() {
    return {
      ...
      tableData: [],
      name: "",
      url: "/main_a/user/get_user_admin",
      paging: {
        size: 10,
        totalElements: 0,
        totalPages: 0,
