    ...
    <base-header class="pb-6">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">Data Broadcast</h6>
      ...
      <div>
        ...
        >
          <template slot="header">
            <h3 class="mb-0">Data Broadcast</h3>
          </template>
...
export default {
  ...
  data() {
    return {
      tableData: [],
      url: "/main_a/broadcast/get_broadcast",
      paging: {
        size: 10,
        totalElements: 0,
        totalPages: 0,
  ...
  methods: {
    ...
    handleEdit(index, row) {
      console.log(row);
      swal.fire({
        title: `You want to edit ${row.question}`,
        buttonsStyling: false,
    ...
    deleteRow(row) {
      this.$axios
        .$delete("/main_a/broadcast/broadcast/" + row.id_)
        .then((user) => {
          swal.fire({
            title: "Deleted!",
